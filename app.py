...
def inject_cart_count():
    """
    Make cart item count available as `cart_count` in all templates.
    Counts total quantity of items in the session cart.
    """
...
# --------------------------------
# ROUTE 1: Home Route (First Flask Route)
# --------------------------------
@app.route('/')
def home():
...
# =================================================================
# ROUTE 5: ADMIN LOGIN PAGE (GET + POST)
# =================================================================
...
# =================================================================
# ROUTE 6: FORGOT PASSWORD - SHOW FORGOT PASSWORD PAGE
# =================================================================
@app.route('/admin/forgot_password')
def forgot_password():
...
# =================================================================
# ROUTE 7: FORGOT PASSWORD - SEND RESET LINK TO EMAIL
# =================================================================
...
# =================================================================
# ROUTE 8: RESET PASSWORD - VERIFY TOKEN + SHOW RESET PASSWORD PAGE
# =================================================================
@app.route('/admin/reset_password/<token>', methods=['GET', 'POST'])
def reset_password(token):
    try:
        email = s.loads(token, salt='password-reset-salt', max_age=300)  # valid for 5 minutes
...
# =================================================================
# ROUTE 9: ADMIN DASHBOARD (PROTECTED ROUTE)
# =================================================================
...
def admin_dashboard():
    ...
    return render_template("admin/dashboard.html", admin_name=session['admin_name'], products=products, categories=categories)



# =================================================================
# ROUTE 10: ADMIN LOGOUT
# =================================================================
...
# =================================================================
# ROUTE 11: SHOW ADD PRODUCT PAGE (Protected Route)
# =================================================================
...
# =================================================================
# ROUTE 12: ADD PRODUCT INTO DATABASE
# =================================================================
...
#=================================================================
# ROUTE 13: VIEW SINGLE PRODUCT DETAILS
# =================================================================
...
# =================================================================
# ROUTE 14: SHOW UPDATE FORM WITH EXISTING DATA
# =================================================================
...
# =================================================================
# ROUTE 15: UPDATE PRODUCT + OPTIONAL IMAGE REPLACE
# =================================================================
...
# =================================================================
# ROUTE 16: DELETE PRODUCT (DELETE DB ROW + DELETE IMAGE FILE)
# =================================================================
...
# =================================================================
# ROUTE 17: SHOW ADMIN PROFILE DATA
# =================================================================
...
# ------------------- ADMIN PROFILE IMAGE UPLOAD PATH -------------------
ADMIN_UPLOAD_FOLDER = 'static/uploads/admin_profiles'
app.config['ADMIN_UPLOAD_FOLDER'] = ADMIN_UPLOAD_FOLDER

# =================================================================
# ROUTE 18: UPDATE ADMIN PROFILE (NAME, EMAIL, PASSWORD, IMAGE)
# =================================================================
...
# ================================================================
# ROUTE 19: ADMIN VIEW ALL ORDERS
# ================================================================
...
# ================================================================
# ROUTE 20: ADMIN VIEW ORDER DETAILS
# ================================================================
...
# ================================================================
# ROUTE 21: ADMIN UPDATE ORDER STATUS
# ================================================================
...
# ---------------------------------------------------------
# ROUTE 4: VERIFY OTP + SAVE USER
# ---------------------------------------------------------
@app.route('/verify-otp-user', methods=['GET', 'POST'])
def verify_otp_user():
    ...
    cursor.execute(
        ...
        (session['signup_name'], session['signup_email'], hashed_password, address)
    )
    conn.commit()
    cursor.close()
    conn.close()
...
# =================================================================
# ROUTE 5: USER LOGIN PAGE (GET + POST)
# =================================================================
...
def user_login():
    ...
    # Step 5: If login success → Create user session
...
# =================================================================
# ROUTE 9: USER DASHBOARD (PROTECTED ROUTE)
# =================================================================
@app.route('/user-home',methods=['GET','POST'])
def user_home():

    # Protect dashboard → Only logged-in user can access
...
# =================================================================
# ROUTE 11: USER PRODUCT DETAILS PAGE
# =================================================================
@app.route('/user/product-details/<int:product_id>')
...
# =================================================================
# ROUTE 17a: UPDATE USER ADDRESS FROM CHECKOUT
# =================================================================
...
def update_user_address():
    ...
    conn = get_db_connection()
    cursor = conn.cursor()
    cursor.execute("UPDATE users SET address=? WHERE user_id=?", (new_address, session['user_id']))
    conn.commit()
    cursor.close()
    conn.close()
...
# =================================================================
# ROUTE 17b: CREATE RAZORPAY ORDER
# =================================================================
@app.route('/user/pay')
def user_pay():
...
# ------------------------------
# ROUTE 19: Verify Payment and Store Order
# ------------------------------
...
def download_invoice(order_id):
    ...
    # Render invoice HTML
    html = render_template("user/invoice.html", order=order, items=items, user=user)
